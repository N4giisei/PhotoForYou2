        ...
        <form method="POST" class="form-inline mt-md-0">
            ...
            <?php
                if (isset($_SESSION['login']) && $_SESSION['login']==False )
                {
                    ...
                    <li class="nav-item">
                        <a class="nav-link btn btn-outline-dark" href="inscription.php">Sinscrire</a></li>
                    <li class="nav-item">
                        <a class="nav-link btn btn-outline-dark"  type="submit"  href="connexion.php">Sidentifier</a>
                    </li>
                    </ul>';
                }
                else
